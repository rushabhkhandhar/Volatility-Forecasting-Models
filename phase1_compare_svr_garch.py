"""
Merge GARCH and SVR forecasts for direct comparison.
Saves merged DataFrame to outputs/COMPARISON_OUTPUT/comparison_final.csv
"""
...
GARCH_CSV = Path("outputs/phase1/final_volatility_forecasts.csv")
SVR_CSV = Path("outputs/SVR_OUTPUT/svr_rolling_forecasts.csv")
OUT_DIR = Path("outputs/COMPARISON_OUTPUT")
